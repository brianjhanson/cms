...
import {normalFilter} from './modules/normal-filter.jsx'
import {pag} from './modules/pagination.jsx'

export function craftTemplate(h, modules, classes, slots) {
    var moduleNormalFilter = normalFilter.call(this, h);
    var modulePagination = pag.call(this, h);
    ...
    var genericFilter = this.hasGenericFilter ? (
        <div class="toolbar">
            <div class="flex">
                {slots.beforeFilter}
                {moduleNormalFilter(classes, filterId)}
